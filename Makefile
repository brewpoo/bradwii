...
OBJECTS    = bradwii.o lib_usb.o rx.o serial.o output.o gyro.o accelerometer.o imu.o baro.o checkboxes.o compass.o autotune.o aircraft.o pilotcontrol.o autopilot.o uncrashable.o eeprom.o gps.o navigation.o vectors.o lib_pwm.o lib_digitalio.o lib_timers.o lib_i2c.o lib_serial.o lib_fp.o
# to run at 8mhz:
